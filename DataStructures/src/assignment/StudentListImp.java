...
public class StudentListImp {
	...
	k.getLastIndex(k);
	System.out.println("\nData Contains: ");
	System.out.println(k.contains(k, new Student(597,"GOPI","B.COM")));
	System.out.println("\nData Contains: ");
	System.out.println(k.contains(k, new Student(943,"AKHIL","AI" )));
	System.out.println("\nData Contains: ");
	System.out.println(k.contains(k, new Student(265, "KUMAR", "ECE" )));

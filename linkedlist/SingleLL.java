...
//		System.out.println("count of nodes in list: " + list.getCount(head));
		System.out.println("count of valus of nodes in list: " + list.countValuesInList(15));
		System.out.println("smallest node from list: " + list.SmallestElement(head));
		System.out.println("largest node from list: " + list.LargestElement(head));
	}
